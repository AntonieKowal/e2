...
<body>
    ...
    <p>The user can choose from the three options of Rock, Paper, or Scissors. When the user submits their choice, 
        the computer randomly selects a choice from the three options as well. Paper beats Rock, Scissors beats Paper, and Rock beats Scissors. 
    ...
    <ul>
        <li>The player chose <?php echo $playerMove ?></li>
        <li>The computer chose <?php echo $computerMove ?></li>
